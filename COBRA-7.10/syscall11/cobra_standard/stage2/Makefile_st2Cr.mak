...
CFLAGS = -ffunction-sections -fdata-sections -Os -m64 -fno-builtin -fno-exceptions \
			   ...
			   -DLV2 -DCEX_KERNEL -DFIRMWARE_4_21 -DCFW -DUSE_LV1_PEEK_POKE -ffreestanding 
CFLAGS += --std=gnu99
...
OBJS = stage2/start.o stage2/main.o stage2/crypto.o stage2/modulespatch.o stage2/config.o stage2/psp_s.o stage2/mappath.o stage2/storage_ext.o stage2/region.o stage2/psp.o stage2/permissions.o  \
...
all: stage2.cexr
	rm -f src/*.o *.elf stage2/*.map stage2/*.map *.map *.lzma lv2/src/*.o lv1/src/*.o debug/src/*.o

objdump: stage2.cexr
	$(OBJDUMP) -D -EB -b binary -m powerpc:common64 stage2.cexr
...
clean:
	rm -f stage2/*.o *.elf *.bin *.cex *.cexr stage2/*.map *.lzma lv2/src/*.o lv1/src/*.o debug/src/*.o
