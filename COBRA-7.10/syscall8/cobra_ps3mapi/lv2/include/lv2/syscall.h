...
#define SYS_DBG_READ_PROCESS_MEMORY									200 /* Added */
#define SYS_DBG_WRITE_PROCESS_MEMORY								201 /* Added */
#define LV2_PEEK_CCAPI												203 /* Added */
#define LV2_POKE_CCAPI												204 /* Added */
