...
#define PS3MAPI_CORE_MINVERSION			 		0x0111
		...
		#define PS3MAPI_FW_TYPE			 			"DEX REBUG MAMBA"
	#endif
	#ifndef IS_MAMBA
		#define PS3MAPI_FW_VERSION			 		0x0421
		#define PS3MAPI_FW_TYPE			 			"DEX REBUG COBRA"
	#endif
	#define PS3MAPI_IDPS_1			 			0x80000000003F7A30ULL
	#define PS3MAPI_IDPS_2			 			0x800000000048FE9CULL
	// #define PS3MAPI_IDPS_3			 			0x80000000004C498CULL
	// #define PS3MAPI_IDPS_4			 			0x8000000000600F8CULL
	...
	#ifdef IS_MAMBA
		#define PS3MAPI_FW_VERSION			 		0x0421
		#define PS3MAPI_FW_TYPE			 			"CEX REBUG MAMBA"
	#endif
	#ifndef IS_MAMBA
		#define PS3MAPI_FW_VERSION			 		0x0421
		#define PS3MAPI_FW_TYPE			 			"CEX REBUG COBRA"
	#endif
	#define PS3MAPI_IDPS_1			 			0x80000000003D9230ULL
	#define PS3MAPI_IDPS_2			 			0x8000000000477E9CULL
	// #define PS3MAPI_IDPS_3			 			0x800000000060818CULL
