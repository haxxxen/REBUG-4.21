...
#define PS2EMU
#define PS2NETEMU
#define FIRMWARE_4_21

#include "../ps2emu/include/ps2emu/symbols.h"

#define read_iso_size_call	0x12D588
#define fstat_iso_call		0x12D47C
#define open_iso_call1		0x12D440
#define open_iso_call2		0x12E4F0
#define savedata_patch		0x113470

#define ADDITIONAL_CODE_SIZE		0x6800
#define ADDITIONAL_DATA_SIZE		0x1000

#define CODE_SECTION_ADDR		0x283B18
#define DATA_SECTION_ADDR		0xB20F80
// #define PAYLOAD_ADDR		(CODE_SECTION_ADDR-0x2702C0+20) /* CODE_SECTION_ADDR - DISTANCE_0x13858 + 20 to align to 0x10 */
// #define PAYLOAD_ADDR		(CODE_SECTION_ADDR-0x2801D8+24) /* CODE_SECTION_ADDR - DISTANCE_0x3958 + 24 to align to 0x10 */
#define PAYLOAD_ADDR		(CODE_SECTION_ADDR+0x78+32) /* CODE_SECTION_ADDR + CODE_SECTION_SIZE + 32 to align to 0x10 */
#define SH_ADDR			0x29A700 /* look in self, not in elf */
...
int main(int argc, char *argv[])
{
	...
	command15("scetool", "-v", "--sce-type=SELF", "--compress-data=TRUE", "--compress-data=TRUE", "--skip-sections=FALSE", 
		 "--self-auth-id=1020000401000001", "--self-add-shdrs=TRUE", "--self-vendor-id=02000003", "--self-type=LV2", 
	         "--self-fw-version=0004002000000000", "--key-revision=0", "--self-app-version=0004002000000000", "--encrypt", "temp.elf", self_output);
