...
/* #if defined(DEX_KERNEL)
	if (!PS3MAPI_IDPS_3) return ESRCH;
	*(uint64_t *)PS3MAPI_IDPS_3 = part1;
	*(uint64_t *)(PS3MAPI_IDPS_3+8) = part2;
	if (!PS3MAPI_IDPS_4) return ESRCH;
	*(uint64_t *)PS3MAPI_IDPS_4 = part1;
	*(uint64_t *)(PS3MAPI_IDPS_4+8) = part2;
#endif */
	return SUCCEEDED;
}
