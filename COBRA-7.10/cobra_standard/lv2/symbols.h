...
#define patch_func2_offset 				0x2C //5920C
#define patch_func8 					0x55F40 //lv2open update patch
#define patch_func8_offset1 				0xA4 //55FE4 lv2open update patch
#define patch_func8_offset2 				0x208 //56148 lv2open update patch
#define patch_func9 					0x5969C // must upgrade error
#define patch_func9_offset 				0x470 //59B0C
