...
/* 
#if defined(FIRMWARE_4_21_CEX)
#define BASE	stage0_base_421C.bin
#define STRING	string_421C.bin
#endif
#if defined(FIRMWARE_4_21_DEX)
#define BASE	stage0_base_421D.bin
#define STRING	string_421D.bin
#endif
 */
...
/* static void command7(char *cmd, char *arg1, char *arg2, char *arg3, char *arg4, char *arg5, char *arg6, char *arg7)
{
	char buf[2048];
	snprintf(buf, sizeof(buf), "%s %s %s %s %s %s %s %s", cmd, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
	system(buf);
}
...
/* 
static void patch_base(char *elf, char *base, char *bin, uint64_t address, uint64_t stage0_addr)
{
}
 */
