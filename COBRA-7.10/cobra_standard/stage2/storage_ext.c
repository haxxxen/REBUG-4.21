...
{				
	...
	if (p == vsh_process)
	{
		...
		if (patch != 0)
		{
			...
			{
				case VSH_HASH:
					DPRINTF("Patching Video Mode into spoofed DEBUG VSH..\n"); 
				...
				case VSH_NRM_HASH:
					DPRINTF("Patching Video Mode into normal DEBUG VSH..\n"); 
				...
				case VSH_CEX_HASH:
					DPRINTF("Patching Video Mode into spoofed RETAIL VSH..\n"); 
				...
				default:
					DPRINTF("WARNING: Unknown VSH loaded.\n Cannot patch PSX Video Mode into vsh.self\n");
				break;
			}
		}
	}
