...
CFLAGS = -ffunction-sections -fdata-sections -Os -m64 -fno-builtin -fno-exceptions \
			   ...
			   -DLV2 -DDEX_KERNEL -DFIRMWARE_4_21 -DCFW -DUSE_LV1_PEEK_POKE -ffreestanding 
CFLAGS += --std=gnu99
...
all: stage2.dexr
	rm -f stage2/*.o *.elf stage2/*.map *.map *.lzma lv2/src/*.o lv1/src/*.o debug/src/*.o

objdump: stage2.dexr
	$(OBJDUMP) -D -EB -b binary -m powerpc:common64 stage2.dexr
...
clean:
	rm -f stage2/*.o *.elf *.bin *.dex *.dexr stage2/*.map *.map *.lzma lv2/src/*.o lv1/src/*.o debug/src/*.o
